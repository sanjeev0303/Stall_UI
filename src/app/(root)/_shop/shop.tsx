...
// Exhibitor Component
function Exhibitor({ title = "Sample Exhibitor", description = "Innovative solutions for modern challenges", category = "Technology", isActive = false, slideNumber = 1 }) {
...
export default function StallRoomSlider() {
  ...
  const slides = [
    { title: "Tech Innovation Hub", description: "Cutting-edge AI and Machine Learning solutions", category: "Technology", icon: "💻" },
    { title: "Green Energy Expo", description: "Sustainable energy solutions for the future", category: "Energy", icon: "🔋" },
    { title: "Healthcare Solutions", description: "Advanced medical technologies and treatments", category: "Healthcare", icon: "🏥" },
    { title: "Financial Services", description: "Modern banking and fintech innovations", category: "Finance", icon: "💰" },
    { title: "Education Platform", description: "Digital learning and educational technologies", category: "Education", icon: "📚" },
    { title: "Food & Beverage", description: "Culinary innovations and food technology", category: "F&B", icon: "🍽️" },
    { title: "Fashion & Design", description: "Latest trends in fashion and creative design", category: "Fashion", icon: "👗" },
    { title: "Automotive Tech", description: "Electric vehicles and automotive innovations", category: "Automotive", icon: "🚗" },
    { title: "Travel & Tourism", description: "Explore new destinations and travel solutions", category: "Travel", icon: "✈️" },
    { title: "Sports & Fitness", description: "Athletic equipment and fitness technologies", category: "Sports", icon: "⚽" }
  ];
    ...
    >
      <div className="relative w-full h-full flex flex-col">
        ...
        <div className="absolute top-2 xs:top-3 sm:top-4 left-2 xs:left-3 sm:left-4 right-2 xs:right-3 sm:right-4 z-50 flex justify-between items-center">
          ...
          <button
            ...
            className={`px-2 xs:px-3 sm:px-4 py-1.5 xs:py-2 rounded-full text-xs xs:text-sm font-medium ${
              autoPlay ? 'bg-green-500/80 text-white hover:bg-green-600/80' : 'bg-gray-500/80 text-white hover:bg-gray-600/80'
            }`}
          >
        ...
        <div className="flex-1">
          ...
          <div className="overlay w-10 h-10 absolute top-0 left-0 bg-black z-[9999]" />
          <Floor />
        </div>
        ...
        >
          <svg className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="absolute h-full lg:w-[25vw] md:w-[40vw] bottom-4 right-2 z-[9999] flex flex-1 max-sm:left-1/2 max-sm:-translate-x-1/2 max-sm:right-auto">
