...
const HangingBoard = ({
  ...
  return (
    <div>
      <div className="absolute z-[100] top-0 sm:top-[-20px] md:top-[-30px] lg:top-[-34px] left-1/2 -translate-x-1/2 w-full px-2 sm:px-4">
        {/* Hanging Threads */}
        <div className="absolute flex justify-center w-full" style={{ top: 0 }}>
          {/* Left thread */}
        ...
        <div className="relative top-6 sm:top-8 md:top-10 lg:top-12">
          <div className="w-full max-w-[320px] xs:max-w-[380px] sm:max-w-[480px] md:max-w-[600px] lg:max-w-[800px] xl:max-w-[1000px]
            ...
            {/* Hanging Points */}
            <div className="absolute top-[20px] xs:top-[22px] sm:top-[25px] md:top-[28px] lg:top-[30px]
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-sm xs:text-base sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl
          ...
          <div className="absolute -inset-2 sm:-inset-4 pointer-events-none">
            <div className="absolute top-1 sm:top-2 left-2 sm:left-4
                           ...
                           bg-pink-400 rounded-full opacity-60 animate-ping"></div>
            <div className="absolute top-4 sm:top-6 md:top-8 right-3 sm:right-6
                           w-0.5 sm:w-1 h-0.5 sm:h-1
